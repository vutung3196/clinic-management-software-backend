...
{
    public static class ConvertNumberToTextExtension
    {
        static readonly string[] mNumText = "không;một;hai;ba;bốn;năm;sáu;bảy;tám;chín".Split(';');
        ...
        public static string ConvertToText(this double so)
        {
            if (so == 0)
                return mNumText[0];
            string chuoi = "", hauto = "";
